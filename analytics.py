...
def load_data(city):
    if city == "Montreal":
        url = "http://data.insideairbnb.com/canada/qc/montreal/2022-09-12/data/listings.csv.gz"
    elif city == "New Brunswick":
        url = "http://data.insideairbnb.com/canada/nb/new-brunswick/2022-09-22/data/listings.csv.gz"
    elif city == "Quebec City":
        url = "http://data.insideairbnb.com/canada/qc/quebec-city/2022-09-10/data/listings.csv.gz"
    elif city == "Toronto":
        url = "http://data.insideairbnb.com/canada/on/toronto/2022-09-07/data/listings.csv.gz"
    elif city == "Vancouver":
        url = "http://data.insideairbnb.com/canada/bc/vancouver/2022-09-10/data/listings.csv.gz"
    elif city == "Victoria":
        url = "http://data.insideairbnb.com/canada/bc/victoria/2022-09-22/data/listings.csv.gz"
...
with col1:
    city_name = st.selectbox("Choose City", ("Montreal", "New Brunswick", "Quebec City", "Toronto", "Vancouver", "Victoria"))
...
est_occ_rate_unformatted = df['availability_90'].mean()/90
est_occ_rate = '{:.1%}'.format(est_occ_rate_unformatted)
